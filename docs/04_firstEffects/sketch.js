...
function setup() {
  ...
  gui.addGlobals('drawSkeleton', 'drawEffects', 'backgroundColour', 'drawStroke', 'strokeColour', 'strokeOpacity', 'strokeWidth', 'drawFilled', 'fillColour', 'fillOpacity', 'showCamera', 'shapeToDraw', 'shapeRadius');
}
